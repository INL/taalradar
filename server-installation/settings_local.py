...
BRAND = 'Instituut voor de Nederlandse Taal'
TITLE = 'Crowdsourcingplatform'
LOGO = 'logo-int.png'
COPYRIGHT = 'Instituut voor de Nederlandse Taal'
DESCRIPTION = 'Set the description in your config'
TERMSOFUSE = 'http://okfn.org/terms-of-use/'
DATAUSE = 'http://opendatacommons.org/licenses/by/'
CONTACT_EMAIL = 'info@ivdnt.org'
CONTACT_TWITTER = 'ivdnt'
